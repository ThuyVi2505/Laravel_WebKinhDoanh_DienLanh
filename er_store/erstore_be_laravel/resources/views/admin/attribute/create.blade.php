    ...
    <div class="card mx-2 my-2">
      <div class="card-header py-0 pt-2 align-middle">
        <div class="float-start">
            <h3 class="text-darkcyan fw-bold">THÊM THÔNG SỐ KỸ THUẬT</h3>
        </div>
      </div>
    </div>
    ...
    <form action="{{route('attribute.store')}}" method="POST">
        ...
        <div class="card-body">
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('key') is-invalid @enderror" id="key" name="key" placeholder="Phải có ít nhất 4 kí tự" value="{{old('key')}}">
              @error('key')
