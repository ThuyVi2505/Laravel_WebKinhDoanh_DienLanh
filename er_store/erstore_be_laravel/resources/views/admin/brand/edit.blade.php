...
<div class="container-fluid">
    <div class="card mx-2 my-2">
      <div class="card-header py-0 pt-2 align-middle">
        <div class="float-start">
            <h3 class="text-darkcyan fw-bold">CẬP NHẬT THƯƠNG HIỆU</h3>
        </div>
      </div>
    </div>
  <div class="card mx-2 border-0">
    ...
    <div class="container">
    <form action="{{ route('brand.update',['brand'=> $brand_detail->id]) }}" method="POST" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <div class="card-body">
            <div class="mb-3">
            ...
            <div class="py-3">
                ...
                <div class="form-check form-check-inline me-3">
                    <input class="form-check-input" type="radio" name="isActive" id="isBlock" value="0" {{!$brand_detail->isActive?'checked':''}}>
                    <label class="form-check-label" for="isBlock">KHÓA</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="isActive" id="isShow" value="1" {{$brand_detail->isActive?'checked':''}}>
                    <label class="form-check-label" for="isShow">KÍCH HOẠT</label>
                </div>
            </div>
            {{-- Hình ảnh --}}
            <div class="form-group">
                <label for="thumnail" class="form-label fw-bold text-uppercase" style="color: #008080">Hình ảnh <span class="text-danger fw-normal">(bỏ trống nếu không có thay đổi)</span></label>
